---
title: "现代 Web 布局 - (3) Flexbox 布局基础使用"
date: 2025-01-04T22:33:52+08:00
draft: false
categories:
- Web
---
...
![img](https://s2.loli.net/2025/01/04/KJhMHedsBwaTRv8.png)
...
![img](https://s2.loli.net/2025/01/04/zsnBlO6RWEdUgV2.jpg)
...
![img](https://s2.loli.net/2025/01/04/Aufxt6aYl8XJISi.png)
...
![img](https://s2.loli.net/2025/01/04/18tQAzIwu95XS4G.png)
...
![img](https://s2.loli.net/2025/01/04/sB6VKDhbPrXoYli.jpg)
...
![img](https://s2.loli.net/2025/01/04/Uisacme71nS9RtL.jpg)
...
![img](https://s2.loli.net/2025/01/04/TqV3b1lvcDkBRmg.jpg)
...
![fig-02-09.png](https://s2.loli.net/2025/01/04/Yj3SgEhfZrePHa7.png)
...
![img](https://s2.loli.net/2025/01/04/gPKl6Vx9kYRJCQ5.jpg)
...
![img](https://s2.loli.net/2025/01/04/NLq8bVldnjtES57.jpg)

可用于 Flex 项目上的属性相比于 Flex 容器上要少一点，它主要有：

![img](https://s2.loli.net/2025/01/04/k61K4qg5QNjhRvM.png)
...
![img](https://s2.loli.net/2025/01/04/SUb4cCKwY3PjvH9.jpg)
...
![img](https://s2.loli.net/2025/01/04/TDAtK934YjlhPab.gif)
...
![img](https://s2.loli.net/2025/01/04/LqA42sQjo3n5HlJ.gif)

另外，CSS 的 `writing-mode` 属性的值也将影响 `flex-direction` 属性最终呈现的效果：

![img](https://s2.loli.net/2025/01/04/XExKoV7Jpza8cD3.gif)
...
![img](https://s2.loli.net/2025/01/04/GMzYvhUQFICAO2N.png)
...
![img](https://s2.loli.net/2025/01/04/6W8xoOlF57QsZHD.png)
...
![img](https://s2.loli.net/2025/01/04/BQb63iqjlGxwgKf.jpg)
...
![img](https://s2.loli.net/2025/01/04/lVoktH3bnxPE2qQ.jpg)
...
![img](https://s2.loli.net/2025/01/04/mXWJpKj5OPf3Gub.gif)
...
![img](https://s2.loli.net/2025/01/04/6gFT97KzVlDjZ8R.gif)

事实上它并不是我们所期望的效果，我们所期望的效果是下图这样的，布局需要换行，就需要显式的设置 `flex-wrap` 为 `wrap` 。

![img](https://s2.loli.net/2025/01/04/GPqNfvhCgEYXks7.gif)
...
![img](https://s2.loli.net/2025/01/04/1eXCfBcQAmWVTH4.jpg)

`flex-wrap: wrap-reverse` 同样也受 `flex-direction` 属性取值的影响：

![img](https://s2.loli.net/2025/01/04/XQy2uCR6qkUNWx9.gif)
...
![fig-03-23.jpg](https://s2.loli.net/2025/01/04/v6tm8q4pAcRVEOy.jpg)
...
![img](https://s2.loli.net/2025/01/04/COWu9vSdfHnNMGY.jpg)
...
![img](https://s2.loli.net/2025/01/04/I4TKbUAznBJwYoS.gif)

在 Flexbox 布局中，在 Flex 项目上使用 `order` 属性可以和在 Flex 容器上使用 `flex-direction` 的 `row-reverse` （或 `column-reverse` ）等同的效果：

![img](https://s2.loli.net/2025/01/04/Ojne2t5B8XfbUar.jpg)
...
![img](https://s2.loli.net/2025/01/04/9eQ4KYhDPtBvb5q.gif)
...
![img](https://s2.loli.net/2025/01/04/Ktq7rsfLOXWBNdJ.jpg)
...
![img](https://s2.loli.net/2025/01/04/p89bLexdAiQ4HD5.gif)
...
![img](https://s2.loli.net/2025/01/04/Zk2EYaI8356Nu4H.jpg)
...
![img](https://s2.loli.net/2025/01/04/1SF4HdEUOa25khR.jpg)
...
![img](https://s2.loli.net/2025/01/04/YqzTtlZMKU2RByu.jpg)
